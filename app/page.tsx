...
export default function Home() {
  ...
  return <main>
    <header className={`nav ${navSolid ? "solid" : ""}`}>
      ...
      <nav className="nav-left"><button onClick={() => goCollection("All")}>Shop</button><button onClick={() => goCollection("All")}>New Drop</button><button onClick={() => goCollection("Men")}>Men</button><button onClick={() => goCollection("Women")}>Women</button><button onClick={() => go("unique")}>Unique Finds</button><button onClick={() => go("about")}>About</button></nav>
